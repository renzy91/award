...
public class RedisCacheManager {
    ...
    public static final String AWARD_PREFIX = "award-";
    public static final String AWARD_PUBLISH = "award-publish-";
    public static final String AWARD_USER_PREFIX = "award-user-";
    public static final String AWARD_PHASE_ARRANGE = "award-phase-arrange";
    ...
    public boolean containsKey(String key) throws Exception {
        ...
        log.info("[REDIS] containsKey key={}, contains={}", key, hasKey);
        return hasKey;
    }
     ...
     * @throws Exception
     */
    public void putValue(String key, String value, long timeout, TimeUnit timeUnit) throws Exception {
        ValueOperations<String, String> valueOps = redisTemplate.opsForValue();
...
//    }
    ...
    public void setAdd(String key, String value) {
        ...
        log.info("[REDIS] setAdd key={}, value={}", key, value);
    }

    public String setPop(String key) {
        SetOperations<String, String> opsForSet = redisTemplate.opsForSet();
        String value = opsForSet.pop(key);
        log.info("[REDIS] spop key={}, value={}", key, value);
        return value;
    }
    ...
    public void rightPush(String key, String value) {
        ...
        log.info("[REDIS] rightPush k-v key={}, value={}", key, value);
    }
     ...
     * @param index
     */
    public String indexOf(String key, long index) {
        ListOperations<String, String> opsForList = redisTemplate.opsForList();
        String value = opsForList.index(key, index);
        log.info("[REDIS] indexOf k-index key={}, index={}, value={}", key, index, value);
        return value;
    }
